...
function trimBegEndSpaces(object_value) {
  ...
  while (leading_blanks <= string_end && object_value.charAt(leading_blanks) == " ") { leading_blanks++ }

  // find last nonblank: start with last character and scan backwards
  while (string_end > leading_blanks && object_value.charAt(string_end) == " ") { string_end-- }
